    ...
    details = {
        **payload,
        ...
        "gates": {
            ...
            "compatibility_interface_inventory": "passed",
            "legacy_alias_activation": "blocked",
            "contract_rehearsal": "prepared",
            "consumer_inventory_contract": "prepared",
            "consumer_inventory_collector": "prepared",
            "rollback_contract": "prepared",
            "source_history_import": "not_run",
            "consumer_inventory": "not_run",
            "consumer_migration": "blocked",
